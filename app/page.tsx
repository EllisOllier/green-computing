    ...
    return (
        <div className="font-sans flex flex-col min-h-screen p-8 pb-20 gap-16 sm:p-20 bg-gradient-to-b from-green-50 via-green-100 to-green-200">
            ...
            <main className="flex flex-col gap-16 relative">
                    ...
                    <div className="flex flex-row items-center gap-6 border border-green-300 bg-white/80 shadow-lg w-xl p-4 h-auto rounded-xl">
                        ...
                        <div>
                            ...
                            <p className="text-green-900">
                                ...
                                . Green computing practices help cut this by
                                lowering power use and CO₂ output{" "}
                                <b>
                                    <a
                                        className="text-green-700 underline"
                                ...
                                . The result is cost savings and progress toward
                                sustainability goals like net-zero emissions{" "}
                                <b>
                                    <a
                                        className="text-green-700 underline"
                ...
                <div className="flex justify-start relative">
                    <div className="flex flex-row items-center gap-6 border border-green-300 bg-white/80 shadow-lg w-xl h-auto p-4 rounded-xl">
                        <Image
                            className="border-md rounded-lg shadow"
                            src="/server-virtulisation.png"
                            width={250}
                            height={250}
                            alt="Image for green computing"
                        />
                        <div>
                            ...
                            <p className="text-green-900">
                                ...
                                . Virtualization and cloud services are also
                    ...
                    <div className="flex flex-row items-center gap-6 border border-green-300 bg-white/80 shadow-lg w-xl p-4 h-auto rounded-xl">
                        ...
                        <div>
                            ...
                            <p className="text-green-900">
                                ...
                                . Many cloud providers now run on renewable
                    ...
                    <div className="flex flex-row items-center gap-6 border border-green-300 bg-white/80 shadow-lg w-xl p-4 h-auto rounded-xl">
                        ...
                        <div>
                            ...
                            <p className="text-green-900">
                                ...
                                . Organizations also follow international
                                ...
                                . These policies help businesses and consumers
                    ...
                    <div className="flex flex-row items-center gap-6 border border-green-300 bg-white/80 shadow-lg w-xl p-4 h-auto rounded-xl">
                        ...
                        <div>
                            ...
                            <p className="text-green-900">
                                ...
                                . Green computing is increasingly part of
